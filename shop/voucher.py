...
class Voucher(fakeinheritence):
    ...
    def __init__(self, voucher_name,voucher_desc,voucher_type, voucher_limit, voucher_status,voucher_date,voucher_end_date,create_date,create_by,modified_date,modified_by):
